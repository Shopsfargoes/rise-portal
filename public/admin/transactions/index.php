<?php
// ============================================================
// RISE CAPITAL GROUP — Admin: All Transactions (Global View)
// ============================================================
    ...
    <div class="page-body">
        ...
        <div class="page-header">
            <div>
                ...
                <p class="page-sub">
                    Complete transaction history across all investors
                </p>
            </div>
        ...
        <div class="table-card">
            <div class="table-header">
                <div>
                    ...
                    <div class="table-sub"><?= number_format($total) ?> records</div>
                </div>
